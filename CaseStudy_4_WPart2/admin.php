            ...
            <div class="content" id="content-index">
                ...
                <form action="update_prices.php" method="post" id="update-form">
                    ...
                    <div style="text-align: right;">
                        <input type="submit" value="Update Prices" style="padding: 10px 20px; background-color: #007bff; color: #fff; border: none; cursor: pointer; margin-right: 100px;">
                    </div>
                </form>
            </div>
        </div>
